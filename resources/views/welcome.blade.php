        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="card-hover bg-white rounded-xl p-6 border border-slate-100">
                    <h3 class="text-base font-semibold text-slate-900 mb-1.5">{{ $f['title'] }}</h3>
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
                ...
                <a href="{{ route('templates.index') }}"
                    ...
                    <div class="aspect-[3/4] {{ $tplBgs[$idx] }} p-4 flex flex-col gap-1.5">
                        <div class="w-3/4 h-2.5 {{ $tplLines[$idx] }} rounded"></div>
                        <div class="w-1/2 h-1.5 {{ $tplLines[$idx] }} rounded"></div>
                        <div class="w-full h-1 {{ $tplLines[$idx] }} rounded mt-2"></div>
                        <div class="w-11/12 h-1 {{ $tplLines[$idx] }} rounded"></div>
                        <div class="w-full h-1 {{ $tplLines[$idx] }} rounded"></div>
                        <div class="w-9/12 h-1 {{ $tplLines[$idx] }} rounded"></div>
                        <div class="w-full h-1 {{ $tplLines[$idx] }} rounded mt-2"></div>
                        <div class="w-10/12 h-1 {{ $tplLines[$idx] }} rounded"></div>
                        <div class="w-full h-1 {{ $tplLines[$idx] }} rounded"></div>
                    </div>
                    <div class="p-3">
                        <p class="font-semibold text-sm text-slate-800">{{ $tpl['name'] }}</p>
                        <p class="text-xs text-slate-400 mt-0.5">{{ $tpl['cat'] }}</p>
                    </div>
                </a>
                @endforeach
            </div>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-5">
                ...
                <div class="price-pro rounded-2xl p-8 relative">
                    ...
                    <ul class="space-y-3 mb-8">
                        @foreach(['Không giới hạn CV', 'Tất cả mẫu CV Premium', 'Xuất PDF & PNG chất lượng cao', 'Tuỳ chỉnh màu sắc & font', 'Ưu tiên hỗ trợ'] as $item)
            ...
            <div class="grid md:grid-cols-3 gap-5">
                ...
                <div class="bg-white border border-slate-100 rounded-xl p-6">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <p class="font-semibold text-sm text-slate-900">{{ $t['name'] }}</p>
                            <p class="text-xs text-slate-400">{{ $t['role'] }}</p>
                        </div>
                    </div>
                    <p class="text-sm text-slate-600 leading-relaxed">{{ $t['text'] }}</p>
                </div>
                @endforeach
            </div>
        </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
                <div>
                    <div class="flex items-center gap-2 mb-4">
                        <img src="{{ asset('storage/avatars/logo/logo.png') }}" style="height:28px" alt="CVactive" class="w-auto object-contain opacity-80">
