            ...
            <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div class="hidden md:block">
                    ...
                    <h1 class="mt-4 text-4xl lg:text-5xl font-bold text-slate-900 leading-tight">
                        Chào mừng bạn <br>
                        <span class="text-indigo-500">trở lại!</span>
                    </h1>
                    <p class="mt-4 text-slate-600 text-base leading-relaxed max-w-md">
                        Đăng nhập để tiếp tục chỉnh sửa CV, theo dõi các đơn ứng tuyển và cập nhật thông tin cá nhân của bạn.
                    </p>
                ...
                <div class="w-full">
                    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 p-8 md:p-10">
                        ...
                        <h2 class="hidden md:block text-2xl font-bold text-slate-900">Đăng nhập</h2>
                        ...
                        <p class="mt-6 text-center text-sm text-slate-600">
                            Chưa có tài khoản?
                            <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-700 font-semibold hover:underline">
                                Đăng ký ngay
                            </a>
                        </p>
                    </div>
