            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="hidden md:block">
                    ...
                    <h1 class="mt-5 text-4xl lg:text-5xl font-black text-slate-900 leading-tight tracking-tight">
                        Bắt đầu hành trình<br class="hidden sm:block"> CV của bạn
                    </h1>
                    <p class="mt-4 text-slate-500 text-base leading-relaxed max-w-md">
                        Tạo tài khoản miễn phí, lựa chọn mẫu CV phù hợp và gây ấn tượng với nhà tuyển dụng.
                    </p>
                ...
                <div class="w-full">
                    <div class="bg-white rounded-2xl border border-slate-100 p-8 md:p-10 shadow-sm">
                        <div class="md:hidden mb-6 text-center">
                            <h1 class="text-2xl font-black text-slate-900">Tạo tài khoản</h1>
                            <p class="mt-1 text-sm text-slate-500">Miễn phí, chưa đầy một phút.</p>
                        </div>

                        <h2 class="hidden md:block text-xl font-bold text-slate-900">Tạo tài khoản</h2>
