            ...
            <div class="hidden lg:block lg:w-12 lg:flex-shrink-0">
                <div class="sticky top-24 space-y-3">
                    ...
                    <button type="button" onclick="navigator.clipboard.writeText('{{ request()->fullUrl() }}'); this.classList.add('text-emerald-600');"
                        class="flex items-center justify-center w-10 h-10 rounded-full bg-white border border-slate-200 text-slate-500 hover:bg-emerald-50 hover:text-emerald-600 hover:border-emerald-200 active:scale-[0.92] transition">
